    ...
    <header className="sticky top-0 z-50 w-full border-b border-border bg-background/95 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          {/* 4-Color Brand Palette Indicator */}
          <div
            className="hidden md:flex items-center gap-1 px-2 py-1 rounded-full bg-card border border-border"
            title="Brand Palette: #08D9D6 (Cyan), #FF2E63 (Pink), #252A34 (Dark), #EAEAEA (Light)"
          >
            <span className="w-2.5 h-2.5 rounded-full bg-brand-cyan border border-brand-cyan/40 shadow-xs" />
            <span className="w-2.5 h-2.5 rounded-full bg-brand-pink border border-brand-pink/40 shadow-xs" />
            <span className="w-2.5 h-2.5 rounded-full bg-brand-dark border border-border shadow-xs" />
            <span className="w-2.5 h-2.5 rounded-full bg-brand-light border border-border shadow-xs" />
          </div>
